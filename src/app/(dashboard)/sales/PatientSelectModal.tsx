      ...
      <div className="bg-white rounded-2xl w-full max-w-3xl shadow-2xl flex flex-col max-h-[85vh] overflow-hidden" style={{ animation: "modal-pop 0.3s ease-out" }}>
        ...
        <div className="p-4 border-b border-[#E2E8F0]">
          <div className="relative">
            ...
            <input type="text" value={search} onChange={e => setSearch(e.target.value)} placeholder="ค้นหา HN, ชื่อ, เบอร์โทร, เลขบัตร..." className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-white border border-[#E2E8F0] text-sm focus:outline-none focus:ring-2 focus:ring-[#3B82F6]/50 transition-all" />
          </div>
        </div>
