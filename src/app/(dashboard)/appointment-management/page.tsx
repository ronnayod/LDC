...
interface Appointment {
  ...
  room: string;
  cc: string;
  status: "Check-in" | "รอตรวจ" | "สำเร็จ" | "ยกเลิก" | "นัดพรุ่งนี้" | "ยืนยันนัด" | "เลื่อนนัด" | "ติดต่อไม่ได้";
  isStarred?: boolean;
}
...
const emptyForm = {
  ...
  room: "",
  cc: "",
  status: "นัดพรุ่งนี้" as Appointment["status"],
  isStarred: false,
};
...
const initialAppointments: Appointment[] = [
  { id: "1", date: "2026-04-21", timeStart: "09:00", timeEnd: "10:00", projectName: "ตรวจสุขภาพฟัน", patientName: "สมชาย ใจดี", patientHn: "HN-0001", phone: "081-234-5678", branch: "ศรีนครินทร์", dentist: "ทพญ. แพรวพรรณ สุขใจ", room: "SN01", cc: "ตรวจฟัน ขูดหินปูน", status: "นัดพรุ่งนี้" },
  { id: "2", date: "2026-04-21", timeStart: "09:30", timeEnd: "10:30", projectName: "อุดฟัน", patientName: "สมหญิง รักสวย", patientHn: "HN-0002", phone: "082-345-6789", branch: "ศรีนครินทร์", dentist: "ทพ. ศรัณย์ มาทำนา", room: "SN02", cc: "อุดฟันกรามล่างซ้าย", status: "นัดพรุ่งนี้", isStarred: true },
  { id: "3", date: "2026-04-21", timeStart: "10:00", timeEnd: "11:30", projectName: "รักษารากฟัน", patientName: "วิชัย สุขสันต์", patientHn: "HN-0003", phone: "083-456-7890", branch: "ศรีนครินทร์", dentist: "ทพญ. แดนสนรยา มาทำนา", room: "SN03", cc: "รักษารากฟันซี่ 36", status: "ยืนยันนัด" },
  { id: "4", date: "2026-04-21", timeStart: "10:30", timeEnd: "11:30", projectName: "ถอนฟัน", patientName: "นภา ดวงจันทร์", patientHn: "HN-0004", phone: "084-567-8901", branch: "ศรีนครินทร์", dentist: "ทพ. ศรัณย์ มาทำนา", room: "SN02", cc: "ถอนฟันคุดบน", status: "เลื่อนนัด" },
  { id: "5", date: "2026-04-21", timeStart: "11:00", timeEnd: "12:00", projectName: "จัดฟัน", patientName: "พิชัย กล้าหาญ", patientHn: "HN-0005", phone: "085-678-9012", branch: "ศรีนครินทร์", dentist: "ทพญ. แพรวพรรณ สุขใจ", room: "SN01", cc: "ปรับเหล็กจัดฟัน", status: "ติดต่อไม่ได้" },
  { id: "6", date: "2026-04-21", timeStart: "13:00", timeEnd: "14:00", projectName: "ทำฟันปลอม", patientName: "สุดา แก้วมณี", patientHn: "HN-0006", phone: "086-789-0123", branch: "ศรีนครินทร์", dentist: "ทพญ. แดนสนรยา มาทำนา", room: "SN04", cc: "ทำฟันปลอมแบบถอดได้", status: "ยืนยันนัด" },
  { id: "7", date: "2026-04-21", timeStart: "13:30", timeEnd: "14:30", projectName: "ฟอกสีฟัน", patientName: "ประเสริฐ ศรีสะอาด", patientHn: "HN-0007", phone: "087-890-1234", branch: "ศรีนครินทร์", dentist: "ทพ. ศรัณย์ มาทำนา", room: "SN05", cc: "ฟอกสีฟัน", status: "เลื่อนนัด" },
  { id: "8", date: "2026-04-22", timeStart: "09:00", timeEnd: "10:00", projectName: "ตรวจสุขภาพฟัน", patientName: "รัชนี ดอกไม้", patientHn: "HN-0008", phone: "088-901-2345", branch: "ศรีนครินทร์", dentist: "ทพญ. แพรวพรรณ สุขใจ", room: "SN01", cc: "ตรวจฟัน", status: "นัดพรุ่งนี้" },
  { id: "9", date: "2026-04-22", timeStart: "10:00", timeEnd: "11:00", projectName: "ขูดหินปูน", patientName: "ชัยวัฒน์ มั่นคง", patientHn: "HN-0009", phone: "089-012-3456", branch: "ศรีนครินทร์", dentist: "ทพญ. แดนสนรยา มาทำนา", room: "SN03", cc: "ขูดหินปูนทั้งปาก", status: "ยืนยันนัด", isStarred: true },
  { id: "10", date: "2026-04-22", timeStart: "11:00", timeEnd: "12:00", projectName: "ผ่าฟันคุด", patientName: "กัลยา สวัสดี", patientHn: "HN-0010", phone: "080-123-4567", branch: "ศรีนครินทร์", dentist: "ทพ. ศรัณย์ มาทำนา", room: "SN02", cc: "ผ่าฟันคุดล่างขวา", status: "ติดต่อไม่ได้" },
  ...
  { id: "13", date: "2026-04-25", timeStart: "09:00", timeEnd: "10:00", projectName: "จัดฟัน", patientName: "สุดา แก้วมณี", patientHn: "HN-0006", phone: "086-789-0123", branch: "ศรีนครินทร์", dentist: "ทพญ. แพรวพรรณ สุขใจ", room: "SN01", cc: "ติดเหล็กจัดฟัน", status: "นัดพรุ่งนี้" },
  { id: "14", date: "2026-04-25", timeStart: "10:30", timeEnd: "11:30", projectName: "ขูดหินปูน", patientName: "ประเสริฐ ศรีสะอาด", patientHn: "HN-0007", phone: "087-890-1234", branch: "ศรีนครินทร์", dentist: "ทพ. ศรัณย์ มาทำนา", room: "SN02", cc: "ขูดหินปูน ต่อนัดทำสะพานฟัน", status: "เลื่อนนัด" },
  { id: "15", date: "2026-04-28", timeStart: "13:00", timeEnd: "14:30", projectName: "รักษารากฟัน", patientName: "ชัยวัฒน์ มั่นคง", patientHn: "HN-0009", phone: "089-012-3456", branch: "ศรีนครินทร์", dentist: "ทพญ. แดนสนรยา มาทำนา", room: "SN03", cc: "รักษารากฟันรอบ 2", status: "ยืนยันนัด" },
  { id: "16", date: "2026-04-30", timeStart: "09:30", timeEnd: "10:30", projectName: "อุดฟัน", patientName: "กัลยา สวัสดี", patientHn: "HN-0010", phone: "080-123-4567", branch: "ศรีนครินทร์", dentist: "ทพ. ศรัณย์ มาทำนา", room: "SN02", cc: "อุดฟัน 2 ซี่", status: "นัดพรุ่งนี้" },
];

const tabOptions = ["ทั้งหมด", "นัดพรุ่งนี้", "ยืนยันนัด", "เลื่อนนัด", "ติดต่อไม่ได้", "ติดดาว"];
const statusOptions = ["ทั้งหมด", "Check-in", "รอตรวจ", "สำเร็จ", "ยกเลิก", "นัดพรุ่งนี้", "ยืนยันนัด", "เลื่อนนัด", "ติดต่อไม่ได้"];
...
export default function AppointmentsPage() {
  ...
  const [activeTab, setActiveTab] = useState("นัดพรุ่งนี้");
  ...
  const filtered = appointments.filter((a) => {
    ...
    let matchTab = true;
    if (activeTab === "ติดดาว") {
      matchTab = !!a.isStarred;
    } else if (activeTab !== "ทั้งหมด") {
      matchTab = a.status === activeTab;
    }

    return matchSearch && matchStatus && matchBranch && matchTab;
  });
  ...
  const statusBadge: Record<string, string> = {
    ...
    "นัดพรุ่งนี้": "bg-blue-50 text-[#0072FF]",
    "ยืนยันนัด": "bg-emerald-50 text-emerald-600",
    "เลื่อนนัด": "bg-[#E0EAFF] text-[#2B5998]",
    "ติดต่อไม่ได้": "bg-purple-50 text-purple-600",
  };
  ...
  const statusDot: Record<string, string> = {
    ...
    "ยกเลิก": "bg-red-500",
    "นัดพรุ่งนี้": "bg-[#0072FF]",
    "ยืนยันนัด": "bg-emerald-500",
    "เลื่อนนัด": "bg-[#2B5998]",
    "ติดต่อไม่ได้": "bg-purple-500",
  };
  ...
  const statusDotSmall: Record<string, string> = {
    ...
    "ยกเลิก": "bg-red-400",
    "นัดพรุ่งนี้": "bg-[#0072FF]",
    "ยืนยันนัด": "bg-emerald-400",
    "เลื่อนนัด": "bg-[#2B5998]",
    "ติดต่อไม่ได้": "bg-purple-400",
  };
  ...
  const openEdit = (a: Appointment) => {
    ...
    setFormData({
      ...
      dentist: a.dentist, room: a.room, cc: a.cc, status: a.status, isStarred: a.isStarred || false,
    });
    setFormErrors({});
    setModalMode("edit");
    setOpenMenu(null);
    ...
    <div className="space-y-6">
        ...
        <div className="animate-fade-in">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-[#E2E8F0] overflow-hidden">
            ...
            <div className="flex items-center gap-6 px-6 py-3 border-t border-[#E2E8F0] bg-[#FAFBFC]">
              ...
              {Object.entries(statusBadge).map(([status]) => (
      ...
      {viewMode === "table" && (
        <div className="animate-fade-in space-y-4">
          {/* ═══ Tabs ═══ */}
          <div className="flex items-center gap-2 border-b border-[#E2E8F0] pb-2 overflow-x-auto min-w-0">
            {tabOptions.map((tab) => (
              <button
                key={tab}
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-[#1E3A5F]">
                    ...
                    <th className="text-left px-4 py-3.5 text-xs font-semibold text-white uppercase tracking-wider">ชื่อคนไข้</th>
                    <th className="text-left px-4 py-3.5 text-xs font-semibold text-white uppercase tracking-wider">เบอร์โทร</th>
                    <th className="text-left px-4 py-3.5 text-xs font-semibold text-white uppercase tracking-wider">ชื่อทันตแพทย์</th>
                    <th className="text-left px-4 py-3.5 text-xs font-semibold text-white uppercase tracking-wider">วันที่นัดหมาย</th>
                    <th className="text-left px-4 py-3.5 text-xs font-semibold text-white uppercase tracking-wider">การรักษา</th>
                    ...
                    <tr key={a.id} className={`${i % 2 === 1 ? "bg-[#F8FAFC]" : "bg-white"} hover:bg-[#E0EAFF]/30 transition-colors`}>
                      ...
                      <td className="px-4 py-3.5">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs text-[#94A3B8]">({a.patientHn})</span>
                        </div>
                      </td>
                      ...
                      <td className="px-4 py-3.5">
                        <div className="flex flex-col text-sm text-[#475569]">
                          ...
                          <span className="text-xs text-[#94A3B8]">{a.timeStart}</span>
                        </div>
                      </td>
      ...
      {modalMode === "view" && selectedAppointment && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm animate-fade-in">
          <div className="bg-white rounded-2xl w-full max-w-3xl shadow-2xl mx-4 max-h-[90vh] flex flex-col overflow-hidden" style={{ animation: "modal-pop 0.25s ease-out" }}>
            {/* Header */}
            <div className="flex items-center justify-between px-8 py-5 bg-[#1E3A5F] flex-shrink-0">
              <h3 className="text-lg font-bold text-white">รายละเอียดการจัดการนัดหมาย</h3>
              <div className="flex items-center gap-3">
                <span className="inline-flex items-center px-3 py-1 text-sm font-semibold rounded-full bg-white text-[#1E3A5F]">
                  {selectedAppointment.status}
                </span>
                <button onClick={() => { setModalMode("closed"); setSelectedAppointment(null); }} className="text-white hover:text-red-400 transition-colors">
            ...
            <div className="overflow-y-auto p-8 flex-1 bg-[#F8FAFC]">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white p-6 rounded-2xl shadow-sm border border-[#E2E8F0]">
                
                {/* Column 1: Patient */}
                <div className="border rounded-xl border-[#E2E8F0] p-5">
                  <h4 className="text-sm font-bold text-[#1E293B] border-b border-[#E2E8F0] pb-2 mb-4">รายละเอียดคนไข้</h4>
                  <div className="space-y-3">
                    <div className="flex"><span className="w-28 text-sm font-semibold text-[#64748B]">ชื่อ - นามสกุล</span><span className="text-sm font-medium text-[#1E293B]">: {selectedAppointment.patientName}</span></div>
                    <div className="flex"><span className="w-28 text-sm font-semibold text-[#64748B]">HN</span><span className="text-sm font-medium text-[#1E293B]">: {selectedAppointment.patientHn}</span></div>
                    <div className="flex"><span className="w-28 text-sm font-semibold text-[#64748B]">เบอร์โทรศัพท์</span><span className="text-sm font-medium text-[#1E293B]">: {selectedAppointment.phone}</span></div>
                    <div className="flex"><span className="w-28 text-sm font-semibold text-[#64748B]">การรักษาล่าสุด</span><span className="text-sm font-medium text-[#1E293B]">: {selectedAppointment.projectName} - {formatDate(selectedAppointment.date)}</span></div>
                  </div>
                </div>

                {/* Column 2: Treatment */}
                <div className="border rounded-xl border-[#E2E8F0] p-5">
                  <h4 className="text-sm font-bold text-[#1E293B] border-b border-[#E2E8F0] pb-2 mb-4">รายละเอียดการรักษา</h4>
                  <div className="space-y-3">
                    <div className="flex"><span className="w-32 text-sm font-semibold text-[#64748B]">ทันตแพทย์ที่รักษา</span><span className="text-sm font-medium text-[#1E293B]">: {selectedAppointment.dentist}</span></div>
                    <div className="flex"><span className="w-32 text-sm font-semibold text-[#64748B]">ห้องทำงาน</span><span className="text-sm font-medium text-[#1E293B]">: {selectedAppointment.room}</span></div>
                    <div className="flex"><span className="w-32 text-sm font-semibold text-[#64748B]">วันที่รักษา</span><span className="text-sm font-medium text-[#1E293B]">: {formatDate(selectedAppointment.date)} {selectedAppointment.timeStart} น.</span></div>
                    <div className="flex"><span className="w-32 text-sm font-semibold text-[#64748B]">การรักษา</span><span className="text-sm font-medium text-[#1E293B]">: {selectedAppointment.projectName}</span></div>
                    <div className="flex"><span className="w-32 text-sm font-semibold text-[#64748B]">CC</span><span className="text-sm font-medium text-[#1E293B] line-clamp-2">: {selectedAppointment.cc || "-"}</span></div>
                  </div>
                </div>
              </div>

              {/* QR Code section */}
              <div className="bg-white mt-6 rounded-2xl shadow-sm border border-[#E2E8F0] py-6 flex justify-center">
                <div className="bg-white p-2 border-2 border-dashed border-[#CBD5E1] rounded-xl flex items-center justify-center relative w-48 h-48 overflow-hidden">
                  <div className="text-[#94A3B8] flex flex-col items-center justify-center opacity-70">
                    <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2" /><rect x="7" y="7" width="3" height="3" /><rect x="14" y="7" width="3" height="3" /><rect x="7" y="14" width="3" height="3" /><rect x="14" y="14" width="3" height="3" /></svg>
            ...
            {/* Footer */}
            <div className="flex justify-center items-center gap-3 px-8 py-5 flex-shrink-0 bg-white border-t border-[#E2E8F0]">
              <button onClick={() => { setAppointments(prev => prev.map(a => a.id === selectedAppointment.id ? {...a, status: "ติดต่อไม่ได้"} : a)); setModalMode("closed"); setSelectedAppointment(null); }} className="px-5 py-2.5 rounded-lg border border-[#A855F7] text-[#A855F7] bg-white font-semibold flex items-center gap-2 hover:bg-purple-50 transition-all">
                ติดต่อไม่ได้
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="6 9 12 15 18 9" /></svg>
              </button>
              
              <button onClick={() => { setAppointments(prev => prev.map(a => a.id === selectedAppointment.id ? {...a, status: "ยืนยันนัด"} : a)); setModalMode("closed"); setSelectedAppointment(null); }} className="px-6 py-2.5 rounded-lg bg-[#22C55E] text-white font-semibold shadow-lg shadow-green-500/20 hover:brightness-110 transition-all">
                ยืนยันนัด
              </button>

              <button onClick={() => openEdit(selectedAppointment)} className="px-6 py-2.5 rounded-lg bg-[#0072FF] text-white font-semibold shadow-lg shadow-blue-500/20 hover:brightness-110 transition-all">
                เลื่อนนัดหมาย
              </button>

              <button onClick={() => { setAppointments(prev => prev.map(a => a.id === selectedAppointment.id ? {...a, isStarred: !a.isStarred} : a)); setSelectedAppointment(prev => prev ? {...prev, isStarred: !prev.isStarred} : null); }} className={`w-11 h-11 flex items-center justify-center rounded-lg border transition-all ${selectedAppointment.isStarred ? 'bg-[#FEF08A] border-[#FACC15]' : 'bg-white border-[#E2E8F0] hover:bg-gray-50'}`}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill={selectedAppointment.isStarred ? "#EAB308" : "none"} stroke={selectedAppointment.isStarred ? "#EAB308" : "#94A3B8"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" /></svg>
              </button>
            </div>
          </div>
        </div>
