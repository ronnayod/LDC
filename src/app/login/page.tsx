      ...
      <div className="relative z-10 w-full max-w-md mx-4 animate-fade-in">
        <div className="glass-card rounded-[20px] p-10">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-[#1E293B] tracking-tight">Lunithic Management</h1>
            <p className="text-sm text-[#64748B] mt-1">ระบบจัดการคลินิก</p>
          </div>
          ...
          <p className="text-center text-xs text-[#94A3B8] mt-8">
            © 2026 Lunithic Management. All rights reserved.
          </p>
        </div>
      </div>
    </div>
